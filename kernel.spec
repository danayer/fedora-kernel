...
%global fedora 44
%define buildid 05.DG2_HuC_MEI_GSC_XE
...
URL: https://gitlab.freedesktop.org/danayer/kernel/
...
Source0: https://gitlab.freedesktop.org/danayer/kernel/-/archive/drm-xe-next/kernel-drm-xe-next.zip
...
# Выдаем права на исполнение перед запуском
chmod +x generate_all_configs.sh merge.py
